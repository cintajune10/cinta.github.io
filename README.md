...
* Machine Learning
   ...
   * [Fake News detection](https://github.com/cintamariyatomy/cinta.github.io/blob/main/%20Fake%20news%20Detection.ipynb): We are given two files with real news and fake news. Here we are using NLP techniques to create a model which predicts whether a given news is real or fake.
